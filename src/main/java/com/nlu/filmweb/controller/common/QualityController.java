...
@RestController
@RequestMapping("/api/v1/film-qualities")
public class QualityController extends CommonController<Quality> {
    @Autowired
    public void setCommonService(CommonService<Quality> commonService) {
