...
@RestController
@RequestMapping("/api/v1/film-languages")
public class LanguageController extends CommonController<Language> {
    @Autowired
    public void setCommonService(CommonService<Language> commonService) {
