...
@RestController
@RequestMapping("/api/v1/film-countries")
public class CountryController extends CommonController<Country> {
    @Autowired
    public void setCommonService(CommonService<Country> commonService) {
